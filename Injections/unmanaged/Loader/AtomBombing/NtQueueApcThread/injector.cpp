/*
    ...
    Menggunakan API NtQueueApcThread
...
Cons:
    ...
    NtQueueApcThread() adalah API internal yang didefinisikan di dalam ntdll.dll
...
// prototype / signature dari NtQueueApcThread
typedef NTSTATUS(WINAPI* lpNtQueueApcThread)(
...
int inject (const int pid, const char* dll_path)
{
    ...
    */
                ...
                spawn   = (lpNtQueueApcThread) GetProcAddress (ntdll_handle_addr, "NtQueueApcThread");
                ...
                printf ("        -> Resolved NtQueueApcThread at %p\n", spawn);
    ...
    */
                ...
                else if (Thread32First (snapshot, &entry))
                {
                    do 
                    {
                        ...
                        spawn (thread, (PIO_APC_ROUTINE)load_lib, alloc_addr, NULL, NULL);
                        ResumeThread (thread);
