...
int inject (const int pid, const char* dll_path)
{
    ...
    */
    ...
    /*
        [5] Dapatkan thread dari remote target.

        Dapatkan alertable thread.
    */
    printf ("[+] Hijacking thread for PID: %d\n", pid);
    printf ("    [=] Finding suitable thread\n");

    /*
        [5.1] Dapatkan snapshot thread saat ini

        Snapshot adalah rekaman kondisi pada suatu waktu.
    */
