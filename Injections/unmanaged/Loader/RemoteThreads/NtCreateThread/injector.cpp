...
int inject (const int pid, const char* dll_path)
{
    ...
    */
                ...
                spawn   = (lpNtCreateThreadEx) GetProcAddress (ntdll_handle_addr, "NtCreateThreadEx");
                ...
                printf ("        -> Resolved NtCreateThreadEx at %p\n", spawn);
    ...
    */
                ...
                spawn (&spawn_thread, THREAD_ALL_ACCESS, nullptr, remote, load_lib, 
                    alloc_addr, NULL,0, 0, 0, nullptr);
                if (! spawn_thread)
                    retcode = 4;
                else
                {
