...
int inject (const int pid, const char* dll_path)
{
    ...
    lpRtlCreateUserThread fn_RtlCreateUserThread;
    ...
    */
    ...
    fn_RtlCreateUserThread = (lpRtlCreateUserThread) GetProcAddress (ntdll_handle_addr, "RtlCreateUserThread");
    ...
    printf ("        -> Resolved RtlCreateUserThread at 0x%08x\n", fn_RtlCreateUserThread);
